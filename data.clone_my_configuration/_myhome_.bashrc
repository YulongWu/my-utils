...
# From page: http://www.tldp.org/LDP/abs/html/sample-bashrc.html

#  This file is normally read by interactive shells only.
#+ Here is the place to define your aliases, functions and
alias hfs="hadoop fs"
# Frankie: function used to generate offline log path on Yidian's hadoop HDFS
# $1 android or iPhone
# $2 date
# $3 hour
function offlinelog_gen(){
    path='/user/azkaban/camus/rawlog_str_pollen_$1/hourly/$2/$3/'
    return path
}
# Frankie: function used as a convenient wrapper of "hadoop fs" command
# $1: hadoop fs command
function hfs()
{
    command="hadoop fs"
